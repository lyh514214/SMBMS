...
<%@include file="/WEB-INF/jsp/common/head.jsp"%>
    <div class="right">
        ...
        <form id="roleForm" name="roleForm" method="post" action="${pageContext.request.contextPath }/sys/role/modifysave">
			<input type="hidden" name="id" value="${role.id }"/>
			 <div>
                    <label for="roleCode">角色编码：</label>
                    <input type="text" name="roleCode" value="${role.roleCode }" readonly="readonly">
             </div>
			 <div>
